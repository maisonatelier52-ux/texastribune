...
export default function RelatedArticles({ articles }: RelatedArticlesProps) {
  ...
  return (
    <div className="max-w-[760px] mx-auto px-4 sm:px-6 lg:px-8 mb-8 mt-2">
      <h2 className="text-[14px] font-bold font-sans text-black mb-4">
        Related
      </h2>
          ...
          return (
            <div key={article.id || i} className="flex flex-col">
              <Link href={`/${article.category.toLowerCase().replace(/\s+/g, '-')}/${article.slug}`} className="group mb-2">
                <h3 className="text-[17px] sm:text-[18px] font-[Arial,sans-serif] font-bold text-black leading-[1.2]">
