          ...
          {isShareOpen && (
            <div className="absolute right-0 top-full mt-[10px] w-48 bg-white border border-gray-200 shadow-md z-50">
              ...
              <div className="relative z-10 bg-white flex flex-col pt-1">
                <button onClick={() => handleShare('whatsapp')} className="flex items-center px-4 py-[10px] hover:bg-gray-50 text-[15px] font-bold text-[#2a2a2a] tracking-normal normal-case text-left border-b border-gray-200 border-dotted transition-colors">
                ...
                <button onClick={() => handleShare('linkedin')} className="flex items-center px-4 py-[10px] hover:bg-gray-50 text-[15px] font-bold text-[#2a2a2a] tracking-normal normal-case text-left border-b border-gray-200 border-dotted transition-colors">
                ...
                <button onClick={() => handleShare('instagram')} className="flex items-center px-4 py-[10px] hover:bg-gray-50 text-[15px] font-bold text-[#2a2a2a] tracking-normal normal-case text-left border-b border-gray-200 border-dotted transition-colors">
                  <svg className="w-[18px] h-[18px] mr-3" viewBox="0 0 24 24" fill="none"><rect width="24" height="24" rx="5" fill="white" stroke="#E1306C" strokeWidth="2"/><path d="M12 16.5C14.4853 16.5 16.5 14.4853 16.5 12C16.5 9.51472 14.4853 7.5 12 7.5C9.51472 7.5 7.5 9.51472 7.5 12C7.5 14.4853 9.51472 16.5 12 16.5Z" fill="#E1306C"/><circle cx="17.5" cy="6.5" r="1.5" fill="#E1306C"/></svg>
                  Instagram
                </button>
                <button onClick={() => handleShare('facebook')} className="flex items-center px-4 py-[10px] hover:bg-gray-50 text-[15px] font-bold text-[#2a2a2a] tracking-normal normal-case text-left border-b border-gray-200 border-dotted transition-colors">
                  <svg className="w-[18px] h-[18px] mr-3 fill-[#1877F2]" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                  Facebook
                </button>
                <button onClick={() => handleShare('twitter')} className="flex items-center px-4 py-[10px] hover:bg-gray-50 text-[15px] font-bold text-[#2a2a2a] tracking-normal normal-case text-left transition-colors">
